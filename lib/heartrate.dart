...
class HeartRateCalculator extends StatefulWidget {
  ...
  const HeartRateCalculator({Key? key, required this.camera}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Ensure that you place finger on torch and camera before starting. To save heart beat, click on Save.',
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 13,
